...
class RecyclingInferenceServicer(recycling_pb2_grpc.RecyclingInferenceServicer):
    ...
    Carga el modelo YOLOv8n al inicializar y expone el metodo DetectObjects
    para ejecutar inferencia sobre imagenes recibidas en bytes.

    Attributes:
        model (YOLO): instancia del modelo YOLOv8n cargado en memoria.
    """

    def __init__(self):
        """
        Inicializa el servicer cargando el modelo YOLOv8n desde disco.
        ...
        Raises:
            FileNotFoundError: si el archivo yolov8n.pt no existe y no
                puede descargarse automaticamente.
        """
    ...
    def DetectObjects(self, request, context):
        """
        Ejecuta inferencia YOLOv8 sobre una imagen recibida via gRPC.
